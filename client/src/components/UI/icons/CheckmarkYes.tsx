...
const CheckmarkYes: React.FC<CheckmarkProps> = ({ checked = false, wasChecked = false, size = 56, onToggle, isDarkMode }) => {
    const baseColor = isDarkMode ? "#DDDDDD" : "#BBBBBB";
    const pickedColor = isDarkMode ? "#555555" : "#777777";
    const color = checked ? "#00A000" : wasChecked ? pickedColor : baseColor;
    return (
